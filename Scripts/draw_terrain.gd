...
@export_range(0, 32) var color_octave_offset : int = 2
...
func initialize_render(framebuffer_format : int):
	...
	var source_vertex = FileAccess.get_file_as_string("res://Shaders/terrain_vertex.glsl")
	var source_fragment = FileAccess.get_file_as_string("res://Shaders/terrain_fragment.glsl")
	var source_wire_fragment = FileAccess.get_file_as_string("res://Shaders/terrain_wireframe_fragment.glsl")
...
func _render_callback(_effect_callback_type : int, render_data : RenderData):
	...
	buffer.push_back(1.0)
	buffer.push_back(minf(octave_count, color_octave_offset))
	buffer.push_back(1.0)
	buffer.push_back(1.0)
	buffer.push_back(1.0)
